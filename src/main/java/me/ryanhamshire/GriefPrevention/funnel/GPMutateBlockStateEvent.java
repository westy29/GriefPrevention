 ...
 * Does NOT include blocks with toggleable (two) states, use GPToggleBlockDataEvent
 ...
 * @author RoboMWM
 */
public class GPMutateBlockStateEvent extends GPBaseEvent
{
    /**
     ...
     * @param target
     */
    public GPMutateBlockStateEvent(Event baseEvent, Metadatable source, Location location, Metadatable target)
    {
     ...
     * @param target
     */
    public GPMutateBlockStateEvent(Event baseEvent, Entity sourceEntity, Location location, Metadatable target)
    {
